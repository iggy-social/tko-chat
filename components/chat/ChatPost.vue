		...
		<div class="card-body row">
			...
			<div class="col-10 col-md-11 post-sizing">
				...
				<p class="card-subtitle mb-2 text-muted">
					...
					>
					<span v-if="$config.showFeatures.friendKeys && getChatName">
						·
						<NuxtLink class="link-without-color hover-color" :to="'/keys/?username=' + getChatName"
							><i class="bi bi-key-fill"></i></NuxtLink
					></span>
					...
					<div class="card col-md-6 preview-card">
						...
						>
							...
							>
								...
								<p v-if="collection?.description" class="card-text text-break text-reset">
