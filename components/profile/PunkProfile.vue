				...
				<div class="row">
					...
					<div class="col-md-9 mt-3">
						...
						<div class="mt-4 muted-text" style="font-size: 14px">
							...
							<p
								class="me-4"
								v-if="$config.keysAddress && $config.showFeatures.friendKeys && getChatName"
							>
								<i class="bi bi-key-fill me-2"></i>
								<NuxtLink class="body-color hover-color" :to="'/keys/?username=' + getChatName"
									>Get Friend Key</NuxtLink
								>
							</p>
						...
						<div class="modal-body">
							...
							<div class="mt-3" v-if="userStore.getIsConnectedToOrbis">
								...
								<p v-if="emailForNotificationsSet">
									Currently, the email for notifications is already set. You can change it by entering
									a new email address below:
								</p>

								<p v-if="!emailForNotificationsSet">
									Currently, the email for notifications is NOT yet set. You can add your email
									address below:
								</p>
