<template>
	<div>
		<p class="text-center">
			Claim {{ $config.tokenSymbol }} rewards for the previous period. Make sure to visit this page once per week
		...
		<ul>
			<li>
				Your stake: {{ getLessDecimals(stakeTokenBalance) }} {{ $config.lpTokenSymbol }} ({{
