	...
	<div class="card border scroll-500">
		<div class="card-body">
			...
			<p class="text-break mt-3">
				Iggy Social Demo is showcase of an open-source template that anyone can use to build their own web3
				social app.
			</p>

			<p class="text-break mt-3">
				Web3 Social is a place where social media is fully decentralized, permissionless and all the data is
				owned by users. The way it should be.
			</p>

			<p class="text-break mt-3">
				Let's leave the old world of corporation-controlled social media behind us and move towards a
				decentralized future. We promise, it's going to be a lot of fun!
			</p>
