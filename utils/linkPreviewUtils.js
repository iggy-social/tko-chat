...
function getDunePreview(url) {
	return {
		...
		title: 'Dune',
		description:
			'Blockchain ecosystem analytics by and for the community. Explore and share data from Ethereum, Polygon, Arbitrum, Optimism, and others for free.',
		image: {
...
async function getOpenSeaPreview(url) {
	let finalMetadata = {
		title: 'OpenSea',
		description:
			'OpenSea is the first web3 marketplace for NFTs and crypto collectibles. Browse, create, buy, sell, and auction NFTs using OpenSea today.',
		image: {
